...
class LSTMModel(nn.Module):
    ...
    def forward(self, x):
        out, _ = self.lstm(x)
        out = self.fc(out)  # Pasar la salida a través de la capa lineal
        return out
...
# Crear dataset y dataloaders para el modelo LSTM
...
# Crear instancia del modelo LSTM
...
model_save_path = f"lstm_model_{current_datetime}.pth"
